...
class EffectiveClassMarginLoss(nn.Module):
    ...
    def __init__(self, 
        ...
        self.register_buffer("detection_cls_weight", self._get_detection_weight(n))
    ...
    def _get_detection_weight(self, n):
        """ related to theorem 2 in the paper."""
        a = (n.sum()-n)/n
        w = a * ((1+a)/a).log()
        return w[None]
    ...
    def get_activation(self, cls_score):
        ...
        # the last class is the bg class I believe
